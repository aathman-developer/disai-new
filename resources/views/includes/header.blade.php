<div class="col-12 live_well_head header w-100 px-0 " id="header">
    ...
    <nav class="navbar navbar-expand-lg navbar-light nav_bar h-shadow w-100  pl-0 py-0">
        <!-- <div class=" d-flex new-contact">
            <div class="logo align-items-center py-lg-2 pl-lg-3 d-flex header-p">
                <a href="{{ url('/') }}">
        ...
        <div class="collapse navbar-collapse naranjee-head justify-content-end" id="navbarNavDropdown">
            <ul class="navbar-nav py-1 d-flex align-items-center">
                ...
                <li class="nav-item px-4">
                    <a class="nav-link wht h-clr {{ (Route::current()->uri() == 'modular_kitchen')?'head-active':'head-deactive' }}"
                        href="{{ url('/trustee') }}" 
                        title="MODULAR KITCHEN">TRUSTEES</a>
                ...
                <li class="nav-item px-4">
                    <a class="nav-link font-bold narajee-head neris-semi h-clr wht {{ (Route::current()->uri() == 'how_works')?'head-active':'head-deactive' }}"
                        href="{{ url('/committee') }}" title="HOW IT WORKS">COMMITTEE</a>
                </li>
                <li class="nav-item px-4">
                    <a class="nav-link font-bold narajee-head neris-semi h-clr wht {{ (Route::current()->uri() == 'kitchen_planner')?'head-active':'head-deactive' }}"
                        href="{{ url('/mou') }}" title="KITCHEN PLANNER">MOU & COLLABORATION</a>
                </li>
                <li class="nav-item px-4">
                    <a class="nav-link font-bold narajee-head neris-semi h-clr wht {{ (Route::current()->uri() == 'kitchen_planner')?'head-active':'head-deactive' }}"
                        href="{{ url('/events') }}" title="KITCHEN PLANNER">EVENTS</a>
                </li>
                <li class="nav-item px-4">
                    <a class="nav-link font-bold narajee-head neris-semi h-clr wht {{ (Route::current()->uri() == 'kitchen_planner')?'head-active':'head-deactive' }}"
                        href="{{ url('/gallery') }}" title="KITCHEN PLANNER">PHOTO GALLERY</a>
                </li>
                <li class="nav-item px-4">
                    <a class="nav-link font-bold narajee-head neris-semi h-clr wht {{ (Route::current()->uri() == 'kitchen_planner')?'head-active':'head-deactive' }}"
                        href="{{ url('/view') }}" title="KITCHEN PLANNER">VIEWS & REPORTS</a>
                </li>
    ...
    <ul class="navbar-side d-lg-none" id="navbarSide">
        ...
        <li class="navbar-side-item p-2">
            <a class="nav-link font-9 mixed-side semi_bold_font text-uppercase {{ (Route::current()->uri() == 'modular_kitchen')?'primary-text-color':'text-muted' }}"
                href="{{ url('/modular_kitchen') }}" title="Hospitality">MODULAR KITCHEN</a>
        </li>
        <li class="navbar-side-item p-2">
            <a class="nav-link font-9 mixed-side semi_bold_font text-uppercase {{ (Route::current()->uri() == 'how_works')?'primary-text-color':'text-muted' }}"
                href="{{ url('/how_works') }}" title="HOW IT WORKS">HOW IT WORKS</a>
        </li>
        <li class="navbar-side-item p-2">
            <a class="nav-link font-9 mixed-side semi_bold_font text-uppercase {{ (Route::current()->uri() == 'kitchen_planner')?'primary-text-color':'text-muted' }}"
                href="{{ url('/kitchen_planner') }}" title="KITCHEN PLANNER">KITCHEN PLANNER</a>
        </li>
        ...
        <!-- <li class="navbar-side-item p-2">
            <a class="nav-link font-9 mixed-side text-muted semi_bold_font text-uppercase" href="{{url('/blog')}}"
                title="Blog">Blogs</a>
        </li> -->
    </ul>
</div>