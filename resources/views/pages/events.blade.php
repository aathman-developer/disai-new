...
<div class="col-12 px-0">
    ...
    <div class="container">
        ...
        <p class="about_p py-lg-2">
            ...
            <a href=" http://www.disai.in/2020/07/talk-on-current-trends-in-cyber-crime.html"
                target="_blank">Please click here for details </a>
        </p>
        <p class="about_p py-lg-2">
        ...
        <p class="about_p py-lg-2">
            Launch of the monthly e-magazine <span class="quest">“DiSAI Quest”</span> followed by a 1-day workshop
            on
            Digital
